...
class Tracking {
 public:
  ...
  // MapDrawer* pMapDrawer, Map* pMap, KeyFrameDatabase* pKFDB, const string
  // &strSettingPath, const int sensor);
  Tracking(System *pSys, ORBVocabulary *pVoc, FrameDrawer *pFrameDrawer,
           MapDrawer *pMapDrawer, Map *pMap,
           shared_ptr<PointCloudMapping> pPointCloud, KeyFrameDatabase *pKFDB,
